...
<body>
	...
	<header id="home">
		<!-- Background Image -->
		<div class="bg-img" style="background-image: url('img/bg-admin.jpg')">
				...
				<div class="row">
					...
					<div class="col-md-10 col-md-offset-1">
						<div class="home-content">
							<h2 class="white-text">Admin Page</h2>
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="footer-logo">
						<a href="index.php"><img src="{{ URL::asset('img/Logo_Sipu1.png') }}" alt="logo"></a>
					</div>
					<!-- /footer logo -->
						...
						success: function( res ){
							...
							if( res.error == 0 ){
								...
								swal(
									...
									if(OK){
										window.location.href = "{{ route('dashboardAdminWeb') }}";
									}
								});
							}else{
								$('#login').modal('hide');
								swal(
									...
									if(OK){
										window.location.href = "{{ route('adminpage') }}";
									}
								});
							}
						}

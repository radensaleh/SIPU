  ...
  <div class="container-fluid">
    <div class="navbar-collapse collapse in">
      <ul class="nav navbar-nav navbar-left">
        <li class="navbar-title">Data Jurusan</li>
      </ul>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><span class="fa fa-user-plus"></span> Add Data Jurusan</h4>
      </div>
      <div class="modal-body">
        <form id="modal-form-add" action="{{ route('data-jurusan.store') }}" method="post" role="form">
          {{ csrf_field() }}
          <div class="form-group has-success">
            <label for="id_jurusan" class="form-control-label">ID Jurusan</label>
            <input type="text" id="inputIdUkm" name="id_jurusan" class="form-control" required/>
            <span class="text-warning" ></span>
          </div>
          <div class="form-group has-success">
            <label for="nama_jurusan" class="form-control-label">Nama Jurusan</label>
            <input type="text" id="inputNamaUkm" name="nama_jurusan" class="form-control" required />
          </div>
      </div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form id="modal-form-delete" method="post" action="{{ route('data-jurusan.destroy', 'destroy') }}">
            {{ method_field('delete') }}
            {{ csrf_field() }}
      <div class="modal-body">
            <input type="hidden" name="id_jurusan" id="cat_id" value="">
...
<div class="row">
  ...
  <tbody>
      @foreach($JUR as $key => $data)
        <tr>
          <td>{{ ++$key }}</td>
          <td>{{ $data->id_jurusan }}</td>
          <td>{{ $data->nama_jurusan }}</td>
          <td>
            <button class="btn btn-xs btn-warning" data-toggle="modal" data-target="#editData" data-id_jurusan = "{{ $data->id_jurusan }}" data-nama_jurusan="{{ $data->nama_jurusan }}">
                  <span class="fa fa-edit"></span> Edit
            </button>
            <button class="btn btn-xs btn-danger" data-toggle="modal" data-target="#deleteData" data-id_jurusan = "{{ $data->id_jurusan }}">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <form id="modal-form-edit" method="post" action="{{ route('data-jurusan.update', 'update') }}">
              {{ method_field('patch') }}
              {{ csrf_field() }}
        <div class="modal-body">
              <input type="hidden" name="id_jurusan" id="cat_id" value="">
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function(){
          ...
          $('#editData').on('show.bs.modal', function (event) {
            ...
            var id_jurusan   = button.data('id_jurusan') // Extract info from data-* attributes
            ...
            modal.find('.modal-body #cat_id').val(id_jurusan)
            $("#id_jurusan").prop('disabled', true);
          });
                    ...
                    if( res.error == 0 ){
                      ...
                      swal(
                        ...
                        res.message,
                          ...
                          if(OK){
                            window.location.href = "{{ route('data-jurusan') }}";
                          }
                        });
                    } else{
                        $('#addData').modal('hide');

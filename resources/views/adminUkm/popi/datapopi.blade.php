  ...
  <div class="container-fluid">
    <div class="navbar-collapse collapse in">
      <ul class="nav navbar-nav navbar-left">
        <li class="navbar-title">Data Popi</li>
      </ul>
...
<div class="btn-floating" id="help-actions">
  ...
  <div class="toggle-content">
    <ul class="actions">
      <li><a href="{{ route('PdfPopi', $getid->id_admin) }}"><span class="fa fa-print"></span> Print</a></li>
    </ul>
  </div>
</div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form id="modal-form-delete" method="post" action="{{ route('deletePopi') }}">
            {{ method_field('delete') }}
            {{ csrf_field() }}
      <div class="modal-body">
                  ...
                  if( res.error == 0 ){
                    ...
                    swal(
                      ...
                      res.message,
                        ...
                        if(OK){
                            window.location.href = "{{ route('data-popi', $getid->id_admin) }}";
                        }
                      });
                  } else{
                      $('#deleteData').modal('hide');

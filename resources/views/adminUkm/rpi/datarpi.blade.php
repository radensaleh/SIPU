...
<aside class="app-sidebar" id="sidebar">
  <div class="sidebar-header">
    <a class="sidebar-brand" href="{{ route('dashboardRpi', $getid->id_admin) }}"><span class="highlight">SIPU</span> POLINDRA</a>
  ...
  <div class="sidebar-menu">
    <ul class="sidebar-nav">
      <li>
        <a href="{{ route('dashboardRpi', $getid->id_admin) }}">
          <div class="icon">
      ...
      <li class="active">
        <a href="{{ route('data-rpi', $getid->id_admin ) }}">
          <div class="icon">
            <i class="fa fa-database" aria-hidden="true"></i>
          </div>
          <div class="title">Data UKM RPI</div>
        </a>
      </li>
  ...
  <div class="container-fluid">
    <div class="navbar-collapse collapse in">
      <ul class="nav navbar-nav navbar-left">
        <li class="navbar-title">Data RPI</li>
      </ul>
...
<div class="btn-floating" id="help-actions">
  ...
  <div class="toggle-content">
    <ul class="actions">
      <li><a href="{{ route('PdfRpi', $getid->id_admin) }}"><span class="fa fa-print"></span> Print</a></li>
    </ul>
  </div>
</div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form id="modal-form-delete" method="post" action="{{ route('deleteRpi') }}">
            {{ method_field('delete') }}
            {{ csrf_field() }}
      <div class="modal-body">
                  ...
                  if( res.error == 0 ){
                    ...
                    swal(
                      ...
                      res.message,
                        ...
                        if(OK){
                            window.location.href = "{{ route('data-rpi', $getid->id_admin) }}";
                        }
                      });
                  } else{
                      $('#deleteData').modal('hide');
